...
// Check connection
    ...
    // output data of each row
  						while($row = $result->fetch_assoc()) {
  							echo "<tr><td>".$row["_id"]."</td><td>".$row["name"]."</td><td><button name=".$row["_id"]." id=\"button\" class=\"btn btn-default btn-sm\" type=\"button\"><i class=\"glyphicon glyphicon-list\"></i></button>    </td></tr>";
  						}
  						echo "</tbody></table>";
  					} else {
  						echo "0 results";
